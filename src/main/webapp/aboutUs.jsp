            ...
            <div class="about__row">  
                <div class="about__row__text">
                    ...
                    <h4 class="about__row__sub">
                        Chúng mình là thành viên nhóm 49 môn Lập Trình Web. Hiện tại, đang theo học tại Trường Đại học Nông Lâm, chuyên ngành Công Nghệ Thông Tin. 
                 
                        Dưới sự hướng dẫn của thầy Phan Đình Long, chúng mình đặt mục tiêu học tập và làm việc chăm chỉ cùng nhau để hoàn thành tốt đồ án của môn.
                    
                        Đồ án của chúng mình không chỉ với mục tiêu đạt được thành tích cao, áp dụng những kiến thức đã học mà còn là cơ hội để học hỏi

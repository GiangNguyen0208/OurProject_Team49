        ...
        <div class="left__content">
            ...
            <div class="main-content">
                ...
                <div class="your__cart">
                    <div class="board__cart">
                        <div class="id__product col">
                            <ul>
                                <h3>ID</h3>
                                <div class="info_product_items">
                                    <li><h4>ID 1</h4></li>
                                </div>
                            </ul>
                        </div>
                        <div class="img__product col">
                            <ul>
                                <h3>Hình ảnh</h3>
                                <div class="info_product_items">
                                    <li><img src="" alt=""></li>
                        ...
                        <div class="totalprice__product col">
                            <ul>
                                <h3>Tổng tiền</h3>
                                <div class="info_product_items">
                                    <li><h4>: VNĐ</h4></li>
